...
<body>
    <h1 class="logo"><img src="/img/elevation-logo.png"/></h1>
    <ul class="menu">
        <li>Home</li>
        <li>Apply</li>
        <li>Media</li>
        <li class="current">Content Sales</li>
        <li>Forums</li>
        <li>Logs</li>
        <li>Armory</li>
    </ul>
    ...
    <div class="slider">
        <div class="slides">
            <div class="slide"><img src="http://nebula.wsimg.com/71a9d810f1738b05d0a2c2dfe0f7c2b4?AccessKeyId=A8B4CB0947EC8E05B862&disposition=0&alloworigin=1" alt="" style="width: 100%; height: 350px;"></div>
        </div>
        <div class="controls">
            <ul class="pages">
                <li></li>
